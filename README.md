# Voting Classifier in Scikit-Learn with Shapley Explanations
## Project Description
...
- A **Voting Classifier** algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Voting classifier model implemented using **Scikit-Learn** library.
